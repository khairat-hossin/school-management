    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('bloodgroup.update', $blood_group->id) }}" id="blood_group_create_form" method="POST">
                    @csrf
                    <div class="mb-3 row">
                        <label for="blood_group" class="col-sm-2 col-form-label">Blood Group: </label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="blood_group" id="blood_group" value="{{$blood_group->blood_group}}">
                        </div>
                    </div>
