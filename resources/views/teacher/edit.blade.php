            ...
            <div class="card-body">
                <form action="{{route('teacher.update', $teacher->id)}}" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="tsubject" id="tsubject" value="{{$teacher->tsubject}}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="tblood_group" id="tblood_group" value="{{$teacher->tblood_group}}">
                        </div>
                    </div>
